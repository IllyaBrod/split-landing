...
export default function FlipHover({imageData, title, description, background, backDescription}:
  ...
  return (
    <div className="group max-w-[400px] md:w-[400px] lg:h-[450px]">
      <div className="relative h-full w-full shadow-xl rounded-4xl transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
       ...
       rounded-4xl text-center px-7 pb-7 h-full w-full pt-3 ${background}`}>
        ...
        <div className="absolute inset-0 h-full w-full rounded-4xl px-7 bg-showcase/95 text-center text-slate-200 [transform:rotateY(180deg)] [backface-visibility:hidden]">
